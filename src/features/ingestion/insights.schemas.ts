...
export const boundedContextsSchema = z.object({
  boundedContexts: z.array(nameDescSchema.extend({
...
export const businessEntitiesSchema = z.object({
  businessEntities: z.array(nameDescSchema.extend({
    name: z.string().describe("The name of the item."),
    description: z.string().describe("A concise description (max 3 sentences)."),
...
export const businessProcessesSchema = z.object({
  businessProcesses: z.array(nameDescSchema.extend({
    name: z.string().describe("The name of the item."),
    description: z.string().describe("A concise description (max 3 sentences)."),
...
export const technologiesSchema = z.object({
  technologies: z.array(nameDescSchema.extend({
    name: z.string().describe("The name of the item."),
    description: z.string().describe("A concise description (max 3 sentences)."),
  })).describe("A list of key external and host platform technologies depended on by the application."),
});
