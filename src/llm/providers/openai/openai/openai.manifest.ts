...
const OPENAI_EMBEDDINGS_MODEL_KEY = "OPENAI_EMBEDDINGS_MODEL";
const OPENAI_COMPLETIONS_MODEL_PRIMARY_KEY = "OPENAI_COMPLETIONS_MODEL_PRIMARY";
const OPENAI_COMPLETIONS_MODEL_SECONDARY_KEY = "OPENAI_COMPLETIONS_MODEL_SECONDARY";
...
export const openAIProviderManifest: LLMProviderManifest = {
  ...
  envSchema: z.object({
    ...
    [OPENAI_EMBEDDINGS_MODEL_KEY]: z.string().min(1),
    [OPENAI_COMPLETIONS_MODEL_PRIMARY_KEY]: z.string().min(1),
    [OPENAI_COMPLETIONS_MODEL_SECONDARY_KEY]: z.string().min(1),
  }),
  models: {
    embeddings: {
      internalKey: GPT_EMBEDDINGS_TEXT_3SMALL,
      urn: getRequiredLLMEnv(OPENAI_EMBEDDINGS_MODEL_KEY),
    ...
    primaryCompletion: {
      ...
      urn: getRequiredLLMEnv(OPENAI_COMPLETIONS_MODEL_PRIMARY_KEY),
    ...
    secondaryCompletion: {
      ...
      urn: getRequiredLLMEnv(OPENAI_COMPLETIONS_MODEL_SECONDARY_KEY),
      purpose: LLMPurpose.COMPLETIONS,
  ...
  factory: (envConfig, modelsInternallKeySet, modelsMetadata, errorPatterns) => {
    const env = envConfig as BaseEnvVars & { 
      ...
      [OPENAI_EMBEDDINGS_MODEL_KEY]: string;
      [OPENAI_COMPLETIONS_MODEL_PRIMARY_KEY]: string;
      [OPENAI_COMPLETIONS_MODEL_SECONDARY_KEY]: string;
    };
