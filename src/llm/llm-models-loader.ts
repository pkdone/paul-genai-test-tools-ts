 ...
 */
class LLMModelsLoader {
  // Private fields
  private static instance: LLMModelsLoader;
  ...
  static getInstance() {
    ...
    if (!LLMModelsLoader.instance) {
      LLMModelsLoader.instance = new LLMModelsLoader(jsonLlmModelsData);
      Object.freeze(LLMModelsLoader.instance);
    }

    return LLMModelsLoader.instance;
  }
...
const llmModelsLoaderSrvc = LLMModelsLoader.getInstance();
export { llmModelsLoaderSrvc, LLMModelsLoader };
