...
export const modelMappings = {
  ...
  AWS_NOVA_EMBEDDINGS_MODEL_KEY: ModelKey.AWS_EMBEDDINGS_TITAN_V1,
  AWS_NOVA_COMPLETIONS_MODELS_KEYS: [ModelKey.AWS_COMPLETIONS_NOVA_PRO_V1, ModelKey.AWS_COMPLETIONS_NOVA_LITE_V1],
  AWS_DEEPSEEK_EMBEDDINGS_MODEL_KEY: ModelKey.AWS_EMBEDDINGS_TITAN_V1,
  AWS_DEEPSEEK_COMPLETIONS_MODELS_KEYS: [ModelKey.AWS_COMPLETIONS_DEEPSEEKE_R1],
} as const;
