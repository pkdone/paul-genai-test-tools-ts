...
process.env.OPENAI_COMPLETIONS_MODEL_PRIMARY = "gpt-4o";
process.env.OPENAI_COMPLETIONS_MODEL_SECONDARY = "gpt-4-turbo";

// Azure OpenAI API variables
process.env.AZURE_LLM_API_KEY = "test-azure-key";
process.env.AZURE_API_ENDPOINT = "https://test.openai.azure.com/";
process.env.AZURE_API_EMBEDDINGS_MODEL = "test-embeddings";
process.env.AZURE_API_COMPLETIONS_MODEL_PRIMARY = "test-primary";
process.env.AZURE_API_COMPLETIONS_MODEL_SECONDARY = "test-secondary";
process.env.AZURE_OPENAI_EMBEDDINGS_MODEL_URN = "text-embedding-ada-002";
process.env.AZURE_OPENAI_COMPLETIONS_MODEL_PRIMARY_URN = "gpt-4o";
process.env.AZURE_OPENAI_COMPLETIONS_MODEL_SECONDARY_URN = "gpt-4-turbo";

// GCP VertexAI API variables
process.env.GCP_API_PROJECTID = "test-gcp-project";
process.env.GCP_API_LOCATION = "us-central1";
process.env.VERTEXAI_EMBEDDINGS_MODEL = "text-embedding-005";
process.env.VERTEXAI_COMPLETIONS_MODEL_PRIMARY = "gemini-2.5-pro-preview-05-06";
process.env.VERTEXAI_COMPLETIONS_MODEL_SECONDARY = "gemini-2.0-flash-001";

// AWS Bedrock API variables
process.env.BEDROCK_EMBEDDINGS_MODEL = "amazon.titan-embed-text-v1";
